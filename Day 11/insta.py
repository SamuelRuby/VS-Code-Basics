...
#browser.find_element_by_xpath('(//button@name= 'only allow essential cookies)').click()
time.sleep(1.5)
...
'''
<div class="_7UhW9   xLCgt        qyrsm            uL8Hv        T0kll ">Follow</div>
'''
...
def click_to_follow(browser):
    ...
    try:
        ...
        pass
#browser.find_elements_by_xpath(my_follow_btn_xpath)
...
#to automate a comment on IG
def automate_comment(browser, content="You're so awesome!"):
    time.sleep(3)
    ...
    submit_btns_xpath = "button[type='submit']"   #with xpath
...
#to automatically trigger a like event
