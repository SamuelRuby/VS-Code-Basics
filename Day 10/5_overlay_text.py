...
intro_duration = 5
intro_text = TextClip("Hello My Neighbours!", fontsize=70, color='white', size=video_clip.size)
...
watermark_size = 60
watermark_text = TextClip("RUBY", fontsize=watermark_size, color='white', align='West', size=(w, watermark_size))
