...
duration = clip.duration #or clip.reader.duration
max_duration = int(duration) + 1
for i in range (0, max_duration):
    frame = clip.get_frame(i)
    #print (frame) #at this point, will give a numpy array corresponding to the pixels in the image. you can run #inference
#install pillow to turn a numpy array into any given image. 
