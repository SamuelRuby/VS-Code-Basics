...
#above is an in-line iteration. Anoter way to do this will be down
#filepaths = []
#for fname in this_dir:
 #   if fname.endwith('jpg'):
  #      path = os.path.join(thumbnail_dir, fname)
   #     filepaths.append(path)

#print(filepaths)
#clip = ImageSequenceClip(filepaths, fps = 4)
#clip = ImageSequenceClip(filepaths, fps = 1) #if you want it to be every second
...
#using imageclip function from the image editor package
my_clips = []
